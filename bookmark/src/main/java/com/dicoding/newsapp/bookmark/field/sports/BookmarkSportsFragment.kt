package com.dicoding.newsapp.bookmark.field.sports
...
import com.dicoding.newsapp.bookmark.databinding.FragmentBookmarkSportsBinding
import com.dicoding.newsapp.core.ui.adapter.adapterbookmark.SportsAdapter
...
class BookmarkSportsFragment : Fragment() {
    ...
    private var binding: FragmentBookmarkSportsBinding? = null

    private var bookmarkAdapter: SportsAdapter? = null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentBookmarkSportsBinding.inflate(inflater, container, false)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            bookmarkViewModel.sportsBookmark.observe(viewLifecycleOwner, { dataBookmark ->

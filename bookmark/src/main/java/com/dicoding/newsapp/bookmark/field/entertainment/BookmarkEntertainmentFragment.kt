...
class BookmarkEntertainmentFragment : Fragment() {
    ...
    private var binding: FragmentBookmarkEntertainmentBinding? = null

    private var bookmarkAdapter: EntertainmentAdapter? = null

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentBookmarkEntertainmentBinding.inflate(inflater, container, false)
        return binding?.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (activity != null) {
            ...
            bookmarkAdapter = EntertainmentAdapter()
